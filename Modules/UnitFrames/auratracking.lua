...
function UnitFrames:SetupAuraTracking(unit)
    local result = {}
    local data = defaultTracking[unit] or {}
    for frameID, aura_data in ipairs(data) do
        result[frameID] = {}
        for spellID, d in pairs(aura_data.Whitelist or {}) do
            AddBuff(result[frameID], spellID, d.Priority, d.Position, aura_data.TexturedIcon, d.Color)
        end
        result[frameID].Blacklist = aura_data.Blacklist or {}
...
UnitFrames.DebuffsTracking["PvE"] = {
    ...
    ["spells"] = {
        ...
        --------------------------------------------------------
        -- The Tarragrue
        [347283] = Priority(true, 5), -- Predator's Howl
        [347286] = Priority(true, 5), -- Unshakeable Dread
        [346986] = Priority(true, 3), -- Crushed Armor
        [347269] = Priority(true, 6), -- Chains of Eternity
        [346985] = Priority(true, 3), -- Overpower
        -- Eye of the Jailer
        [350606] = Priority(true, 4), -- Hopeless Lethargy
        [355240] = Priority(true, 5), -- Scorn
        [355245] = Priority(true, 5), -- Ire
        [349979] = Priority(true, 2), -- Dragging Chains
        [348074] = Priority(true, 3), -- Assailing Lance
        [351827] = Priority(true, 6), -- Spreading Misery
        [355143] = Priority(true, 6), -- Deathlink
        [350763] = Priority(true, 6), -- Annihilating Glare
        -- The Nine
        [350287] = Priority(true, 2), -- Song of Dissolution
        [350542] = Priority(true, 6), -- Fragments of Destiny
        [350202] = Priority(true, 3), -- Unending Strike
        [350475] = Priority(true, 5), -- Pierce Soul
        [350555] = Priority(true, 3), -- Shard of Destiny
        [350109] = Priority(true, 5), -- Brynja's Mournful Dirge
        [350483] = Priority(true, 6), -- Link Essence
        [350039] = Priority(true, 5), -- Arthura's Crushing Gaze
        [350184] = Priority(true, 5), -- Daschla's Mighty Impact
        [350374] = Priority(true, 5), -- Wings of Rage
        -- Remnant of Ner'zhul
        [350073] = Priority(true, 2), -- Torment
        [349890] = Priority(true, 5), -- Suffering
        [350469] = Priority(true, 6), -- Malevolence
        [354634] = Priority(true, 6), -- Spite 1
        [354479] = Priority(true, 6), -- Spite 2
        [354534] = Priority(true, 6), -- Spite 3
        -- Soulrender Dormazain
        [353429] = Priority(true, 2), -- Tormented
        [353023] = Priority(true, 3), -- Torment
        [351787] = Priority(true, 5), -- Agonizing Spike
        [350647] = Priority(true, 5), -- Brand of Torment
        [350422] = Priority(true, 6), -- Ruinblade
        [350851] = Priority(true, 6), -- Vessel of Torment
        [354231] = Priority(true, 6), -- Soul Manacles
        [348987] = Priority(true, 6), -- Warmonger Shackle 1
        [350927] = Priority(true, 6), -- Warmonger Shackle 2
        -- Painsmith Raznal
        [356472] = Priority(true, 5), -- Lingering Flames
        [355505] = Priority(true, 6), -- Shadowsteel Chains 1
        [355506] = Priority(true, 6), -- Shadowsteel Chains 2
        [348456] = Priority(true, 6), -- Flameclasp Trap
        [356870] = Priority(true, 2), -- Flameclasp Eruption
        [355568] = Priority(true, 6), -- Cruciform Axe
        [355786] = Priority(true, 5), -- Blackened Armor
        [348255] = Priority(true, 6), -- Spiked
        -- Guardian of the First Ones
        [352394] = Priority(true, 5), -- Radiant Energy
        [350496] = Priority(true, 6), -- Threat Neutralization
        [347359] = Priority(true, 6), -- Suppression Field
        [355357] = Priority(true, 6), -- Obliterate
        [350732] = Priority(true, 5), -- Sunder
        [352833] = Priority(true, 6), -- Disintegration
        -- Fatescribe Roh-Kalo
        [354365] = Priority(true, 5), -- Grim Portent
        [350568] = Priority(true, 5), -- Call of Eternity
        [353435] = Priority(true, 6), -- Overwhelming Burden
        [351680] = Priority(true, 6), -- Invoke Destiny
        [353432] = Priority(true, 6), -- Burden of Destiny
        [353693] = Priority(true, 6), -- Unstable Accretion
        [350355] = Priority(true, 6), -- Fated Conjunction
        [353931] = Priority(true, 2), -- Twist Fate
        -- Kel'Thuzad
        [346530] = Priority(true, 2), -- Frozen Destruction
        [354289] = Priority(true, 2), -- Sinister Miasma
        [347454] = Priority(true, 6), -- Oblivion's Echo 1
        [347518] = Priority(true, 6), -- Oblivion's Echo 2
        [347292] = Priority(true, 6), -- Oblivion's Echo 3
        [348978] = Priority(true, 6), -- Soul Exhaustion
        [355389] = Priority(true, 6), -- Relentless Haunt (Fixate)
        [357298] = Priority(true, 6), -- Frozen Binds
        [355137] = Priority(true, 5), -- Shadow Pool
        [348638] = Priority(true, 4), -- Return of the Damned
        [348760] = Priority(true, 6), -- Frost Blast
        -- Sylvanas Windrunner
        [349458] = Priority(true, 2), -- Domination Chains
        [347704] = Priority(true, 2), -- Veil of Darkness
        [347607] = Priority(true, 5), -- Banshee's Mark
        [347670] = Priority(true, 5), -- Shadow Dagger
        [351117] = Priority(true, 5), -- Crushing Dread
        [351870] = Priority(true, 5), -- Haunting Wave
        [351253] = Priority(true, 5), -- Banshee Wail
        [351451] = Priority(true, 6), -- Curse of Lethargy
        [351092] = Priority(true, 6), -- Destabilize 1
        [351091] = Priority(true, 6), -- Destabilize 2
        [348064] = Priority(true, 6), -- Wailing Arrow

...
function Medias:ChangeSystemFonts()
    ...
    alterFont( 'Game17Font_Shadow', 'Montserrat Light', 17, "NONE", nil, true )
    ...
    alterFont( 'Number13Font', 'Montserrat', 13 )
    alterFont( 'Number15Font', 'Montserrat', 15 )
    alterFont( 'Number16Font', 'Montserrat', 16 )
    alterFont( 'Number18Font', 'Montserrat Light', 18 )
    alterFont( 'NumberFont_Shadow_Large', 'Montserrat Light', 20, "NONE", nil, true )
    ...
    alterFont( 'QuestFont_30', 'Montserrat', 30)
    alterFont( 'QuestFont_39', 'Montserrat', 39)
    ...
    alterFont( 'System15Font', 'Montserrat', 15)
    alterFont( 'SystemFont22_Outline', 'Montserrat', 22, "OUTLINE")
    alterFont( 'SystemFont22_Shadow_Outline', 'Montserrat', 22, "OUTLINE", nil, true)
    alterFont( 'SystemFont_Tiny', 'Montserrat', 9)
    alterFont( 'SystemFont_Tiny2', 'Montserrat', 8)
    ...
    alterFont( 'SystemFont_Huge4', 'Montserrat', 27)
    alterFont( 'SystemFont_Shadow_Huge4', 'Montserrat', 27, "NONE", nil, true)
    alterFont( 'SystemFont_Shadow_Huge4_Outline', 'Montserrat', 27, "OUTLINE", nil, true)
    ...
    alterFont( 'SystemFont_Shadow_Med3_Outline', 'Montserrat', 14, "OUTLINE")
    ...
    alterFont( 'PriceFont', 'Montserrat', 14)
